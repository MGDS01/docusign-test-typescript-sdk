 ...
 */
export function workspaceUsersRestoreWorkspaceUserAccess(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RestoreWorkspaceUserAccessRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/v1/accounts/{accountId}/workspaces/{workspaceId}/users/{userId}/actions/restore-access",
  )(pathParams);
