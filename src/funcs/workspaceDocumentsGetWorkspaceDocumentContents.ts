 ...
 */
export function workspaceDocumentsGetWorkspaceDocumentContents(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWorkspaceDocumentContentsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc(
    "/v1/accounts/{accountId}/workspaces/{workspaceId}/documents/{documentId}/contents",
  )(pathParams);
