 ...
 */
export function workspacesGetWorkspaceEnvelopes(
  client: DocusignTypescriptTest2Core,
  request: operations.GetWorkspaceEnvelopesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetWorkspaceEnvelopesResponse,
    | errors.ErrorDetails
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWorkspaceEnvelopesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetWorkspaceEnvelopesResponse$inboundSchema),
