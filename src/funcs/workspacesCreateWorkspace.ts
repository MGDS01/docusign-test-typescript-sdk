...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateWorkspaceRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateWorkspaceBody, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.CreateWorkspaceResponse$inboundSchema),
