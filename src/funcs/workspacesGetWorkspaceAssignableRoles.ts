 ...
 */
export function workspacesGetWorkspaceAssignableRoles(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWorkspaceAssignableRolesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/v1/accounts/{accountId}/workspaces/{workspaceId}/assignable-roles",
  )(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetWorkspaceAssignableRolesResponse$inboundSchema),
