 ...
 */
export function workspaceUsersRevokeWorkspaceUserAccess(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RevokeWorkspaceUserAccessRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.RevokeWorkspaceUserDetails, {
    explode: true,
  });
  ...
  const path = pathToFunc(
    "/v1/accounts/{accountId}/workspaces/{workspaceId}/users/{userId}/actions/revoke-access",
  )(pathParams);
