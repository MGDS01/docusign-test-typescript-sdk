 ...
 */
export function workspaceDocumentsGetWorkspaceDocuments(
  client: DocusignTypescriptTest2Core,
  request: operations.GetWorkspaceDocumentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetWorkspaceDocumentsResponse,
    | errors.ErrorDetails
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWorkspaceDocumentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetWorkspaceDocumentsResponse$inboundSchema),
